...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  ...
  [L_LOWER] = LAYOUT(                                                                                                            \
    ...
    _______, KC_BSLASH, KC_LT,   KC_GT,   KC_GRAVE, KC_TILD, /**/ KC_PIPE,     KC_KP_PLUS,  KC_COMM,   KC_DOT, KC_SLSH, XXXXXXX, \
  ...
  [L_LOWER_SHIFT] = LAYOUT(                                                                                          \
    ...
    _______, _______, _______, _______, _______, _______, /**/ _______, _______, _______, _______, _______, KC_ASTR, \
                               _______, _______, _______, /**/ _______, _______, _______                             \
  ),
  ...
  [L_RAISE] = LAYOUT(                                                                                                      \
    ...
    _______, KC_F11,  KC_F12, XXXXXXX, XXXXXXX, XXXXXXX, /**/ XXXXXXX,   XXXXXXX, KC_UP,   XXXXXXX,  XXXXXXX, TG(L_MOUSE), \
    _______, KC_Z,    KC_X,   KC_C,    KC_V,    XXXXXXX, /**/ XXXXXXX,   KC_LEFT, KC_DOWN, KC_RIGHT, XXXXXXX, _______,     \
                              _______, _______, _______, /**/ _______,   _______, _______                                  \
  ),
