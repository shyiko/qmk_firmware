...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  ...
  [L_LOWER] = LAYOUT(                                                                                                            \
    ...
    _______, KC_LBRC,   KC_RBRC, KC_LCBR, KC_RCBR, KC_KP_PLUS, /**/ KC_KP_MINUS, KC_COLN, KC_EQUAL, KC_LPRN, KC_RPRN, KC_GRAVE,  \
  ...
  [L_RAISE] = LAYOUT(                                                                                                      \
    ...
    _______, KC_F11,  KC_F12, XXXXXXX, XXXXXXX, XXXXXXX, /**/ XXXXXXX, KC_HOME, KC_UP,   KC_END,   KC_PGUP,   TG(L_MOUSE), \
    _______, KC_Z,    KC_X,   KC_C,    KC_V,    XXXXXXX, /**/ XXXXXXX, KC_LEFT, KC_DOWN, KC_RIGHT, KC_PGDOWN, _______,     \
                              _______, _______, _______, /**/ _______, _______, _______                                    \
  ),

  [L_ADJUST] = LAYOUT(                                                                                                  \
    _______, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, /**/ XXXXXXX,  XXXXXXX, XXXXXXX,   XXXXXXX, XXXXXXX, XXXXXXX, \
    _______, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, KC_PLUS, /**/ KC_MINUS, _______, KC_PGUP,   _______, _______, _______, \
