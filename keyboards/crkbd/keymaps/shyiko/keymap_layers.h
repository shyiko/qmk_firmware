...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  ...
  [L_LOWER] = LAYOUT(                                                                                                            \
    ...
    _______, KC_LBRC,   KC_RBRC, KC_LPRN, KC_RPRN, KC_KP_PLUS, /**/ KC_KP_MINUS, KC_COLN, KC_EQUAL, KC_LCBR, KC_RCBR, KC_GRAVE,  \
  ...
  [L_LOWER_SHIFT] = LAYOUT(                                                                                          \
    ...
    _______, _______, _______, _______, _______, _______, /**/ KC_UNDS, _______, _______, _______, _______, KC_TILD, \
  ...
  [L_RAISE] = LAYOUT(                                                                                                      \
    ...
    _______, KC_F11,  KC_F12, XXXXXXX, XXXXXXX, XXXXXXX, /**/ KC_PGUP,   KC_HOME, KC_UP,   KC_END,   XXXXXXX, TG(L_MOUSE), \
    _______, KC_Z,    KC_X,   KC_C,    KC_V,    XXXXXXX, /**/ KC_PGDOWN, KC_LEFT, KC_DOWN, KC_RIGHT, XXXXXXX, _______,     \
                              _______, _______, _______, /**/ _______,   _______, _______                                  \
  ),

  [L_ADJUST] = LAYOUT(                                                                                                 \
    _______, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, /**/ XXXXXXX, XXXXXXX, XXXXXXX,   XXXXXXX, XXXXXXX, XXXXXXX, \
    _______, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, /**/ _______, _______, KC_PGUP,   _______, _______, _______, \
    _______, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, /**/ _______, KC_HOME, KC_PGDOWN, KC_END,  _______, _______, \
                               _______, _______, _______, /**/ _______, _______, _______                               \
  ),

  [L_EXTRA] = LAYOUT(                                                                                                        \
    _______, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, /**/ KC_BRID, KC_BRIU, LSFT_T(KC_CAPS), KC_PSCR, KC_INS,  _______, \
    _______, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, /**/ XXXXXXX, XXXXXXX, KC_MUTE,         KC_VOLD, KC_VOLU, KC_APP,  \
